...
- **Requirements rule:** jab bhi koi nayi library `pip install` karo, usko `requirements.txt` mein add karo (day-wise comment ke saath — kaunsi library kab/kyun aayi). File hamesha up-to-date rahe.
